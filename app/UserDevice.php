...
class UserDevice extends Model {
    ...
    protected $fillable = ['device_uuid', 'profile_uuid', 'device_type', 'device_token', 'version', 'is_archive'];
    ...
    public static function getUserDeviceByUser($profile_uuid, $device_type = null) {
        $result = UserDevice::where('profile_uuid', '=', $profile_uuid)->where('device_type', '=', $device_type)->first();
