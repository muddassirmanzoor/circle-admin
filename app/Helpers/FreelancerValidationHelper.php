...
{
    public static function freelancerAppointmentRules() {
        $validate['rules'] = [
    ...
    public static function freelancerAppointmentUpdateRules() {
        $validate['rules'] = [
            'appointment_uuid' => 'required',
    ...
    public static function saveFreelancerSubsRules() {
        $validate['rules'] = [
            'freelancer_uuid' => 'required',
            'type' => 'required',
            'price' => 'required'
