...
//                }
    ...
    public static function allPackagesResponseForCustomer($packages = [], $to_currency = 'SAR', $active_classes_count = 0) {
        $response = [];
        if (!empty($packages)) {
            $key = 0;
            foreach ($packages as $package) {
    ...
    public static function purchasedPackageDetailResponse($package = [], $filter_data = []) {
        ...
        if (!empty($package)) {
            ...
            if (!empty($filter_data)) {
                $ids['customer_uuid'] = $filter_data['customer_uuid'];
                $ids['freelancer_uuid'] = $filter_data['freelancer_uuid'];
            }
...
//                    $key++;
    ...
    public static function getPackageAppointmentsPricesResponse($appointments = [], $filter_data = []) {
        ...
        if (!empty($appointments)) {
            foreach ($appointments as $value) {
                if ($value['customer_uuid'] == $filter_data['customer_uuid']) {
...
//                            break;
    ...
    public static function getPurchasedPackageClassSchedulesResponse($value = [], $filter_data = [], $chat_data = []) {
        ...
        $response['uuid'] = $value['schedule']['class_uuid'];
...
//        }
        ...
        $response['package_uuid'] = $value['package_uuid'];
