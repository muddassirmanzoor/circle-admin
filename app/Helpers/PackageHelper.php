...
Class PackageHelper {
    ...
    public static function getSessionPackageDetail($inputs, $add_package_data, $package) {
        ...
        $package_services_array = PackageDataHelper::makeAddPackageServiceArray($add_package_data, $package['package_uuid']);
...
//            $response = PackageResponseHelper::allPackagesResponse($all_packages, $inputs['currency']);
        $all_packages = Package::getAllPackages('freelancer_uuid', $inputs['freelancer_uuid'], (!empty($inputs['limit']) ? $inputs['limit'] : null), (!empty($inputs['offset']) ? $inputs['offset'] : null));
...
//        $response['upcoming_schedules'] = self::getUpcomingSchedulesPackageResponse($class_list);
    ...
    public static function getFreelancerPurchasedPackages($inputs = []) {
        ...
        $all_packages = Package::getPurchasedPackages('freelancer_uuid', $inputs['freelancer_uuid'], (!empty($inputs['limit']) ? $inputs['limit'] : null), (!empty($inputs['offset']) ? $inputs['offset'] : null));
    ...
    public static function getCustomerPurchasedPackages($inputs = []) {
        ...
        $appoint_package_uuid = Appointment::pluckFavIdsWithStatus('customer_uuid', $inputs['customer_uuid'], 'package_uuid');
//        $appoint_package_uuid = Appointment::pluckFavIds('customer_uuid', $inputs['customer_uuid'], 'package_uuid');
        ...
        $class_packages_uuids = ClassBooking::pluckClassBookingIdsWithStatus('customer_uuid', $inputs['customer_uuid'], 'package_uuid');
