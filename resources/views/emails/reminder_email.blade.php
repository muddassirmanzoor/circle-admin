...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            @import url('{{url('assets/admin/assets/global/fonts/opensans.css')}}');
            #outlook a {padding: 0;}
                    ...
                    <td>
                        ...
                        <table style="width: 90%; margin: 0 auto; background-color: #ffffff; padding-top: 20px; padding-left: 20px; padding-bottom: 20px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 100%; float: left; text-align: left; font-size: 25px; color: #606060; text-transform: capitalize; font-weight: 700;">Hi {{!empty($data['appointment_data']['appointment_customer']['first_name'])? $data['appointment_data']['appointment_customer']['first_name']:"Customer"}}!</td>
                                @elseif($data['appointment_data']['send_to']=="freelancer")
                                <td style="width: 100%; float: left; text-align: left; font-size: 25px; color: #606060; text-transform: capitalize; font-weight: 700;">Hi {{!empty($data['appointment_data']['appointment_freelancer']['first_name'])?$data['appointment_data']['appointment_freelancer']['first_name']:"Freelancer"}}!</td>
                                @endif
                            </tr>

                            <tr>
                                <td style="width: 100%; float: left; text-align: left; font-size: 16px; color: #999999; font-weight: 600; margin-top: 10px; margin-bottom: 10px;">You have a {{$data['appointment_data']['status']}} {{($data['email_type']) ?? "appointment"}}:</td>
                            </tr>

                            <tr>
                                @if(!empty($data['appointment_data']['package_detail']) && $data['appointment_data']['email_type'] == "package_appointment")
                                <td style="width: 100%; float: left; text-align: left; font-size: 22px; color: #606060; font-weight: 700;">{{strtoupper($data['appointment_data']['package_detail']['package_name'])}}</td>
                                @endif
                                ...
                                <td>
                                    <table style="width: 90%; margin: 0 auto; background-color: #F9F9F9; border-radius: 10px; padding-top: 30px; padding-left: 20px; padding-bottom: 20px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="max-width: 54px; float: left;"><img src="<?= "http://d2bp2kgc0vgu09.cloudfront.net/uploads/profile_images/freelancers/96/" . $data['appointment_data']['appointment_freelancer']['profile_image']; ?>" style="object-fit: cover; max-width: 54px; border-radius: 100px; width:54px; height: 54px" /></td>
                                            @else
                                            <td style="width: 54px; float: left;"><img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd1a3bf3ed1610469795.png" style="max-width: 54px; border-radius: 100px; width:54px; height: 54px" /></td>
                                            @endif
                                            @elseif($data['appointment_data']['send_to']=="freelancer")
                                            @if(!empty($data['appointment_data']['appointment_customer']['profile_image']))
                                            <td style="max-width: 54px;float: left;"><img src="<?= "http://d2bp2kgc0vgu09.cloudfront.net/uploads/profile_images/customers/96/" . $data['appointment_data']['appointment_customer']['profile_image']; ?>" style="object-fit: cover; max-width: 54px; border-radius: 100px; width:54px; height: 54px"/></td>
                                            @else
                                            <td style="width: 54px; float: left;"><img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd321d3c251610470177.png" style="max-width: 54px; border-radius: 100px; width:54px; height: 54px" /></td>
                                            @endif
                                            @endif
                                            ...
                                            <td style="width: 60%; float: left; padding-left: 10px; padding-top: 3px;">
                                                <table style="width: 100%; float: left;">
                                                    <tbody>
                                                        ...
                                                        @elseif($data['appointment_data']['send_to']=="freelancer")
                                                        <tr><td style="width: 100%; float: left; text-align: left; font-size: 20px; color: #606060; text-transform: capitalize; line-height: 13px; font-weight: 700;">{{!empty($data['appointment_data']['appointment_customer']['first_name'])?$data['appointment_data']['appointment_customer']['first_name']:"Customer"}} {{!empty($data['appointment_data']['appointment_customer']['last_name'])?$data['appointment_data']['appointment_customer']['last_name']:null}}</td></tr>
                                        ...
                                        <tr>
                                            ...
                                            if ($data['appointment_data']['is_online'] == 1) {
                                                $type = "Online";
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 60%; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600;">{{$data['day']}} {{$data['date']}} {{$data['month']}} - {{$data['from_time']}} - {{$data['to_time']}}, {{($data['local_timezone'])?? UTC}}</td>
                                        </tr>
                        ...
                        <table style="width: 90%; margin: 0 auto; border-radius: 10px; background-color: #ffffff; padding-top: 20px; padding-left: 20px; padding-bottom: 30px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr><td height="25"></td></tr>
                                <tr>
                                    <td style="width: 100%; float: left; text-align: center; font-size: 16px; color: #999999; font-weight: 600; margin-top: 10px; margin-bottom: 10px;">Have a great appointment</td>
                                </tr>
                                <tr>
                                    <td style="width: 100%; float: left; margin-top: 25px; margin-bottom: 10px; text-align: center;">
                                        @if(!empty($data['appointment_data']['status']) && $data['appointment_data']['status'] == "confirmed")
                                        ...
                                        @elseif(!empty($data['appointment_data']['status']) && $data['appointment_data']['status'] == "pending")
                                        <a href="#" @if($data["appointment_data"]["status"] == "cancelled") disabled="disabled" @endif style="background-color: #EC625E;color: #ffffff;font-size: 18px;text-align: center;display: inline-block;border-radius: 37px;text-decoration: none;padding-top: 10px;padding-bottom: 10px;padding-left: 45px;padding-right: 45px;margin: auto;">
                                            <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/{{$calender_image}}" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px;"><span style="float: left; margin-top: 2px;">{{ucwords($data['appointment_data']['status'])}}</span>
                                        </a>
                                        @else
