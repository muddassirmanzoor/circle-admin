...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('assets/admin/assets/pages/css/login.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!-- END HEAD -->
    <body class="login" style="background-color: #17C4BB!important;">